  ...
  <div class="page-header">
    ...
    <!-- Licensing -->
      ...
      <div id="licenseInputs" class="form-group" style="display: none;">
          <input type="text" class="licenseCodeBox form-control" style="width: 20%; display:inline-block" placeholder="&nbsp;License Code e.g. XXXXXX-XXXXXX-XXXXXX-XXXXXX-XXXXXX" name="License" id="moduleLicense" value="<?php echo !empty($moduleData['License']) ? $moduleData['License'] : ''?>" />
          <button type="button" class="btn btn-success btnActivateLicense" style="display: none;"><i class="fa fa-check"></i>&nbsp;Activate License</button>
      </div>
